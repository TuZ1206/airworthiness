...
from .graph.neo4j_setup import AviationKnowledgeGraph
import json
import os
...
def search():
    ...
    templates_base_path = os.path.join(os.path.dirname(__file__), 'web', 'templates', 'chapter')
...
def concept_page(name):
    ...
    html_path = os.path.join(os.path.dirname(__file__), 'web', 'concept', f"{name}.html")
...
def image_file_page(name):
    ...
    html_path = os.path.join(os.path.dirname(__file__), 'web', 'image_file', f"{name}.html")
